...
<div class="row">
	<div class="col-md-12">
		<h1><i class="fa fa-plus"></i> Edit Branch</h1>
	</div>
</div>
<div class="row mb-5">
	<div class="col-md-6">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-lg-12 pb-5">
						{!!Form::open(array('route'=>array('branches.update',$branch->id),'method'=>'PUT'))!!}											
							<div class="form-group">
								<div class="col-lg-12">
									{!! Form::label('company_id','Comapny') !!}
									{!! Form::select('company_id',$companies,$branch->company_id,['class'=>'form-control']) !!}
							...
							<div class="form-group">
								<div class="col-lg-12">
									...
									{!! Form::text('branch_code',$branch->branch_code,['class'=>'form-control','placeholder'=>'Enter Branch Code']) !!}
							...
							<div class="form-group">
								<div class="col-lg-12">
									...
									{!! Form::text('branch_name',$branch->branch_name,['class'=>'form-control','placeholder'=>'Enter Branch Name']) !!}
