		...
		if($(chartID).length){
			...
			clickedElement.on(triggeredEvent, function(e){
				...
				switch(range){
					...
					var dataSet3 = [0, 0, 3, 5, 0, 2, 7, 0, 9, 5, 0, 5, 3, 0, 2, 7, 0, 9, 5, 0, 5, 0, 5, 3];

					// Load the chart after all the data has been set
					load_chart(range, xAxisLabels, dataSet1, dataSet2,dataSet3);					
					break;
					...
					var dataSet3 = [50, 60, 20, 30, 60, 90, 3000, 40];
					...
					var dataSet3 = [3, 4, 2, 2, 7, 0, 0, 0, 5, 2, 1, 3, 3, 4, 0, 0, 0, 6, 9, 2, 0, 0, 5, 2, 5, 7, 2, 9, 3, 3, 7];
					...
					var dataSet3 = [1000, 500, 800, 1500, 1300, 2000, 3000, 2000, 1800, 1931, 4000, 4800];
			...
			function load_chart(range, xAxisLabels, dataSet1, dataSet2, dataSet3){
				...
				if(canvasParent.closest('.card').hasClass('card-sm')){
					...
					color3 = qp_hexToRgbA(color3, 0.7);
					var borderWidth = 0;
					var pointRadius = 0;
